...
if __name__ == "__main__":
    ...
    if (args.trainset == "CIFAR10"):
        ...
        simulator = SwinJSCCInferenceCIFAR10(model_path, device="cuda", save_log=True, user=args.user)
    else:
        logger.info("Using DIV2K checkpoint.")
        model_path = "./SwinJSCC_w/SA&RA/SwinJSCC_w_SAandRA_AWGN_HRimage_cbr_psnr_snr.model"
        simulator = SwinJSCCInference(model_path, device="cuda", save_log=True, user=args.user)
    ...
    semantic_coder = SemanticNN(16, 20, 1, "cuda")
